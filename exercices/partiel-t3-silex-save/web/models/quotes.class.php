...
class Quotes_Model
{
    ...
    {
        if(empty($data['id_promotion']) || empty($data['first_name']) || empty($data['last_name']))
            return false;

        $prepare = $this->pdo->prepare('
            INSERT INTO
                students (id_promotion,first_name,last_name)
            VALUES
                (:id_promotion,:first_name,:last_name)
        ');
        $prepare->bindValue('id_promotion',$data['id_promotion']);
        $prepare->bindValue('first_name',$data['first_name']);
        $prepare->bindValue('last_name',strtoupper($data['last_name']));
