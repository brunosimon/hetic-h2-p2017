...
<body>
	<div id="container">
		...
		if(isset($_POST['login']) AND !preg_match("#^[-. ]+$#", $_POST['login'])) 
		{
			...
			{			
				// Création du compte
				$insert = $db->prepare('INSERT INTO chat_accounts (account_id, account_login, account_pass) VALUES(:id, :login, :pass)');
				$insert->execute(array('id' => '','login' => htmlspecialchars($login),'pass' => md5($pass)));
		...
		<table class="status"><tr>
			<td>
				...
				<select name="status" id="status" style="width:200px;" onchange="setStatus(this)">
					...
					<option value="1">Occupé(e)</option>
		...
		<td valign="top" id="text-td">
			...
			<div id="text">
				<div id="loading">
					...
					<img src="loader/ajax-loader.gif" alt="patientez...">
					</center>
				</div>
			</div>
		</td>
